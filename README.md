...
## Contents
- [Awesome-Dataset-Distillation](#awesome-dataset-distillation)
      - [How to submit a pull request?](#how-to-submit-a-pull-request)
  - [Citing Awesome-Dataset-Distillation](#citing-awesome-dataset-distillation)
  - [Contents](#contents)
  - [Main](#main)
    - [Early Work](#early-work)
    - [Gradient/Trajectory Matching Surrogate Objective](#gradienttrajectory-matching-surrogate-objective)
    - [Distribution/Feature Matching Surrogate Objective](#distributionfeature-matching-surrogate-objective)
  ...
  - [Applications](#applications)
    ...
    - [Fashion, Art, and Design](#fashion-art-and-design)
    - [Knowledge Distillation](#knowledge-distillation)
    - [Recommender Systems](#recommender-systems)
    - [Blackbox Optimization](#blackbox-optimization)
    - [Retrieval](#retrieval)
    - [Text](#text)
    - [Tabular](#tabular)
...
+ [CaT: Balanced Continual Graph Learning with Graph Condensation](https://arxiv.org/abs/2309.09455) (Yilun Liu et al., 2023) [:octocat:](https://github.com/superallen13/CaT-CGLD) [:book:](./citations/liu2023cat.txt)
