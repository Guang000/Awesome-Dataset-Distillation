...
+ [Dataset Factorization for Condensation](https://nips.cc/Conferences/2022/Schedule?showEvent=55231) (Songhua Liu et al., NeurIPS 2022) [:octocat:](https://github.com/Huage001/DatasetFactorization) [:book:](./citations/liu2022dataset.txt)
...
+ [Dataset Distillation for Medical Dataset Sharing](https://arxiv.org/abs/2209.14603) (Guang Li et al., 2022) [:octocat:](https://github.com/Guang000/mtt-distillation) [:book:](./citations/li2022sharing.txt)
...
+ [Meta Knowledge Condensation for Federated Learning](https://arxiv.org/abs/2209.14851) (Ping Liu et al., 2022) [:book:](./citations/liu2022meta.txt)
...
## Acknowledgments
We would like to thank [Nikolaos Tsilivis](https://github.com/Tsili42), [Wei Jin](https://github.com/ChandlerBang), [Yongchao Zhou](https://github.com/yongchao97), [Noveen Sachdeva](https://github.com/noveens), [Can Chen](https://github.com/GGchen1997) and [Guangxiang Zhao](https://github.com/zhaoguangxiang) for their valuable suggestions and contributions.
